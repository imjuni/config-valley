...
export class TomlKeyParser extends AbstractJsonKeyParser {
  constructor(key: string) {
    super(CE_CONFIG_SOURCE.TOML, key);
  }
  ...
  override assign<T>(_target: object, ..._sources: object[]): T {
    throw new Error(`Not support assign function in ${TomlKeyParser.constructor.name}`);
  }
